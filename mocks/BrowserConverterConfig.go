...
// JobID provides a mock function for the type BrowserConverterConfig
func (_mock *BrowserConverterConfig) JobID() string {
	ret := _mock.Called()
...
func (_c *BrowserConverterConfig_JobID_Call) Return(s string) *BrowserConverterConfig_JobID_Call {
	_c.Call.Return(s)
	return _c
}
...
// Lineage provides a mock function for the type BrowserConverterConfig
func (_mock *BrowserConverterConfig) Lineage() string {
	ret := _mock.Called()
...
func (_c *BrowserConverterConfig_Lineage_Call) Return(s string) *BrowserConverterConfig_Lineage_Call {
	_c.Call.Return(s)
	return _c
}
...
// ProjectName provides a mock function for the type BrowserConverterConfig
func (_mock *BrowserConverterConfig) ProjectName() string {
	ret := _mock.Called()
...
func (_c *BrowserConverterConfig_ProjectName_Call) Return(s string) *BrowserConverterConfig_ProjectName_Call {
	_c.Call.Return(s)
	return _c
}
...
// ProjectNamespace provides a mock function for the type BrowserConverterConfig
func (_mock *BrowserConverterConfig) ProjectNamespace() string {
	ret := _mock.Called()
...
func (_c *BrowserConverterConfig_ProjectNamespace_Call) Return(s string) *BrowserConverterConfig_ProjectNamespace_Call {
	_c.Call.Return(s)
	return _c
}
