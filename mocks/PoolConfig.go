...
// IdleTimeout provides a mock function for the type PoolConfig
func (_mock *PoolConfig) IdleTimeout() time.Duration {
	ret := _mock.Called()
...
func (_c *PoolConfig_IdleTimeout_Call) Return(duration time.Duration) *PoolConfig_IdleTimeout_Call {
...
// MaxAge provides a mock function for the type PoolConfig
func (_mock *PoolConfig) MaxAge() time.Duration {
	ret := _mock.Called()
...
func (_c *PoolConfig_MaxAge_Call) Return(duration time.Duration) *PoolConfig_MaxAge_Call {
	_c.Call.Return(duration)
	return _c
}
...
// MaxIdle provides a mock function for the type PoolConfig
func (_mock *PoolConfig) MaxIdle() int {
	ret := _mock.Called()
...
func (_c *PoolConfig_MaxIdle_Call) Return(n int) *PoolConfig_MaxIdle_Call {
	_c.Call.Return(n)
	return _c
}
